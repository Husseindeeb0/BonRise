...
const MAIN_NODES = [
  {
    id: "m1",
    start: [150, 150],
    target: [GRID_X[0], GRID_Y[0]],
    icon: ICONS.Shop,
  },
  {
    id: "m2",
    start: [500, 80],
    target: [GRID_X[1], GRID_Y[0]],
    icon: ICONS.Window,
  },
  {
    id: "m3",
    start: [850, 120],
    target: [GRID_X[2], GRID_Y[0]],
    icon: ICONS.ArrowRise,
  },
  {
    id: "m4",
    start: [100, 350],
    target: [GRID_X[0], GRID_Y[1]],
    icon: ICONS.Profile,
  },
  {
    id: "m5",
    start: [900, 350],
    target: [GRID_X[1], GRID_Y[1]],
    icon: ICONS.Location,
  },
  {
    id: "m6",
    start: [150, 520],
    target: [GRID_X[2], GRID_Y[1]],
    icon: ICONS.User,
  },
  {
    id: "m7",
    start: [450, 550],
    target: [GRID_X[0], GRID_Y[2]],
    icon: ICONS.Global,
  },
  {
    id: "m8",
          ...
          return (
            <motion.line
              ...
              animate={{
                ...
                opacity: [0, 0.2, 0.6, 0.4, 0, 0, 0],
                pathLength: [0, 1, 1, 1, 0, 0, 0],
              }}
              transition={TRANSITION}
            />
          );
